...
if __name__ == '__main__':
    ...
    # model2 = resnet18(pretrained=True).to(device)
    # summary(model2,(3,224,224))

    # torch.save(model.state_dict(), os.path.join(CNN_RESNET_SAVED_MODELS_BASE, 'resnet_regression_model_0.pth'))
    # print("Model saved")
    ...
    if continue_train:
        state_dict = torch.load(os.path.join(RESNET18_SAVED_MODELS_BASE, 'resnet_regression_model_1.pth'),
    ...
    torch.save(model.state_dict(), os.path.join(RESNET18_SAVED_MODELS_BASE, 'resnet_regression_model_1.pth'))
    print("Model saved")
