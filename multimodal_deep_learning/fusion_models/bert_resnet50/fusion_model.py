...
class FusionModel(nn.Module):
    def __init__(self):
        ...
        self.conv2_6 = nn.Conv1d(in_channels=512, out_channels=512, kernel_size=3, stride=2, padding=1)
        self.conv2_7 = nn.Conv1d(in_channels=512, out_channels=512, kernel_size=3, stride=2, padding=1)
        self.conv2_8 = nn.Conv1d(in_channels=512, out_channels=256, kernel_size=3, stride=2, padding=1)
        self.fc2_1 = nn.Linear(256 * 8, 256)
        self.fc2_2 = nn.Linear(256, 255)

        self.fc_final1 = nn.Linear(512, 256)
    ...
    def forward(self, input1, input2, input3):
        ...
        x2 = F.relu(self.conv2_7(x2))
        x2 = F.relu(self.conv2_8(x2))
